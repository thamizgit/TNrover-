        ...
        <Row justify="around">
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card className="card" style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-grand.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">GRAND ESTANCIA</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      349/3 Bangalore, Bypass Rd, Narasothipatti, Salem, Tamil
                      Nadu 636004
                    </span>
                  </p>
                </Card.Text>
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">04272777770</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,2800</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/GRAND+ESTANCIA/@11.683375,78.1081385,15z/data=!4m9!1m2!2m1!1shotels+in+salem!3m5!1s0x3babf063add643cd:0x29d6c444c0c765da!5m2!4m1!1i2!15sCg9ob3RlbHMgaW4gc2FsZW1aESIPaG90ZWxzIGluIHNhbGVtkgEFaG90ZWzgAQA"
                  className="locate"
                  variant="primary"
                >
                  Locate
                ...
                <Button
                  className="menu"
                  href="https://d.adx.io/dclicks?xb=35BS11281&xd=30&xtm_source=google&xtm_content&xauto_diux=dxid&xu=http://www.cleartrip.com/hotels/details/171043?hotelID%3D171043&utm_source=GoogleHPA&utm_medium=meta&utm_campaign=171043&c=161022%7C171022&r=2,0"
                  variant="primary"
                >
                  Book
                </Button>
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-radisson.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">Radisson Salem</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      Mamangam, 157/3-A, Bangalore Highway, Salem, Tamil Nadu
                      636302
                    </span>
                  </p>
                </Card.Text>
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">04277111222</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,4480</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                ...
                <Button
                  href="https://www.google.com/maps/place/Radisson+Salem/@11.6922753,78.1129364,17z/data=!3m1!4b1!4m8!3m7!1s0x3babf083de512ab9:0x716ff63940baa558!5m2!4m1!1i2!8m2!3d11.6922753!4d78.1151251"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                className="img"
                variant="top"
                src={require("../images/salem-cj.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">CJ Pallazzio</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      201/6, Junction Main Rd, State Bank Colony, Meyyanur,
                ...
                <Card.Text>
                  <p className="open">
                    Type: <span className="time">4 Star</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">04272556677</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,3960</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/CJ+Pallazzio/@11.6833745,78.1081385,15z/data=!4m9!1m2!2m1!1shotels+in+salem!3m5!1s0x3babf06605bb0f7b:0x6cb77a910a563ec7!5m2!4m1!1i2!15sCg9ob3RlbHMgaW4gc2FsZW1aESIPaG90ZWxzIGluIHNhbGVtkgEFaG90ZWzgAQA"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-windos.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-2">Hotel Windsor Castle</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      14, Rajaji Rd, Peramanur, Salem, Tamil Nadu 636007
                    </span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Type: <span className="time"></span>4 Star
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">04274055600</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,4490</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/Hotel+Windsor+Castle/@11.6670782,78.1492232,17z/data=!3m1!4b1!4m8!3m7!1s0x3babf04a24c001e7:0xae9e78e5aa417385!5m2!4m1!1i2!8m2!3d11.6671147!4d78.1514198"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card className="card" style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-castle.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">Hotel Salem Castle</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      Plot No. A, 4, Bharathi St, Swarnapuri, Salem, Tamil Nadu
                      636004
                    </span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Type: <span className="time">3 Star</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">09843911175</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,2910</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/Hotel+Salem+Castle/@11.6739467,78.1336854,18.68z/data=!4m8!3m7!1s0x3babf042e52f4fb3:0xcf9b1651f60ec1b!5m2!4m1!1i2!8m2!3d11.6737006!4d78.1359332"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-palm.jpeg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">The Palm Residency</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      24/1A/1 Salem - Kochi Highway Chinna Seeragapadi
                      Nallarayampatti,Tamil Nadu 636308
                    </span>
                  </p>
                </Card.Text>
                <Card.Text>
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">08680977777</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,1470</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/The+Palm+Residency/@11.589862,78.0675595,17z/data=!3m1!4b1!4m8!3m7!1s0x3babe5abede7b2a7:0x65ca873094fe6e61!5m2!4m1!1i2!8m2!3d11.5898566!4d78.0697473"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                className="img"
                variant="top"
                src={require("../images/salem-rathna.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">Hotel Rathna Residency</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      E Block Three Roads, 17 14, Suramangalam Main Rd,
                      Pallapatti,Tamil Nadu 636009
                    </span>
                  </p>
                </Card.Text>
                <Card.Text>
                ...
                <Card.Text>
                  <p className="open">
                    Phone : <span className="time">04272446744</span>
                  </p>
                </Card.Text>
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,3847</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/Hotel+Rathna+Residency/@11.6638761,78.1302273,17z/data=!3m1!4b1!4m8!3m7!1s0x3babf01549ed90f3:0x7531bad4aa959741!5m2!4m1!1i2!8m2!3d11.6638761!4d78.132416"
                  className="locate"
                  variant="primary"
                >
                  Locate
          ...
          <Col sm={12} md={5} lg={5} xl={4} xxl={3} className="zoom">
            <Card style={{ width: "350px",margin:"2rem auto" }}>
              <Card.Img
                variant="top"
                src={require("../images/salem-devi.jpg")}
              />
              <Card.Body>
                <Card.Title>
                  <b>
                    <h2 class="display-1">Hotel Devi Towers</h2>
                  </b>
                </Card.Title>
                <Card.Text>
                  <p className="open">
                    Address :
                    <span className="time">
                      166, 166, 3, Sarada College Rd, New Fairlands,
                ...
                <Card.Text>
                  <p className="open">
                    Price : <span className="time">INR,1520</span>
                  </p>
                </Card.Text>
                ...
                <Button
                  href="https://www.google.com/maps/place/Hotel+Devi+Towers/@11.6757551,78.1331715,17z/data=!3m1!4b1!4m8!3m7!1s0x3babf05d34e9444d:0x8e7223dcb0393cea!5m2!4m1!1i2!8m2!3d11.6757551!4d78.1353602"
                  className="locate"
                  variant="primary"
                >
                  Locate
