...
function ChennaiHospital(){
    return(
        <div>
            ...
            <Container className="back" fluid>
                ...
                <Row justify="around">
                  <Col md={12} className="head"><h2>Restaurants in Chennai</h2></Col>
                </Row>
      ...
      <Card.Img variant="top" src={require('./royalvega.jpg')  } />
      <Card.Body>
        <Card.Title><b><h2 class="display-1">ROYAL VEGA</h2></b></Card.Title>
        ...
        <Card.Text>
            <p className="open">Open Hours : <span className="time">7–11:30pm</span></p>
        </Card.Text>
        <Card.Text>
            <p className="open">Phone : <span className="time">044 2220 0000</span></p>
        </Card.Text>
        <Card.Text>
        ...
        <Button href="https://goo.gl/maps/1FgYhdxBdo1L9Nov7" className="locate" variant="primary">Locate</Button>
    ...
    <Col md={3} className="zoom"> 
      ...
      <Card.Img variant="top" src={require('./annalak.jpg')  } />
      <Card.Body>
        <Card.Title><b><h2 class="display-1">Annalakshmi</h2></b></Card.Title>
        <Card.Text><p className="open">
          Address  :<span className="time"> No 6 Mayor Ramanathan Salai, Spur Tank road, Chennai, Tamil Nadu 600031</span></p>
        </Card.Text>
        <Card.Text>
            <p className="open">Type: <span className="time">Vegetarian</span></p>
        </Card.Text>
        ...
        <Button href="https://goo.gl/maps/Y6peUaREpVCZEZ9ZA" className="locate" variant="primary">Locate</Button>
    ...
    <Col md={3} className="zoom"> 
                <Card style={{ width: '350px' }}>
      <Card.Img className="img" variant="top" src={require('./paprika.jpg')  } />
      <Card.Body>
        <Card.Title><b><h2 class="display-1">PAPRIKA</h2></b></Card.Title>
        <Card.Text><p className="open">
          Address  :<span className="time"> Courtyard by Marriott, 564, Anna Salai, Teynampet, Thiru Vi Ka Kudiyiruppu, Teynampet</span></p>
        </Card.Text>
        <Card.Text>
        ...
        <Card.Text>
            <p className="open">Phone : <span className="time">044 6676 4000</span></p>
        </Card.Text>
        <Card.Text>
        ...
        <Button  href="https://goo.gl/maps/Vua2RMFdkJGwKhcz7" className="locate" variant="primary">Locate</Button>
        
        <Button className="menu"  href="https://online.fliphtml5.com/tfzrw/kbdq/#p=1" variant="primary">Menu</Button>
